...
class TestTransactionSingleOp < Minitest::Test
  ...
  def test_read_NotFound()
    key = "_Read_NotFound"
    conn = Scalaris::TransactionSingleOp.new()
    assert_raises( Scalaris::NotFoundError ) { conn.read(@testTime.to_s + key) }
    conn.close_connection()
  end
  ...
  def test_read_not_connected()
    ...
    conn = Scalaris::TransactionSingleOp.new()
    conn.close_connection()
    #assert_raises( Scalaris::ConnectionError ) { conn.read(@testTime.to_s + key) }
    assert_raises( Scalaris::NotFoundError ) { conn.read(@testTime.to_s + key) }
    conn.close_connection()
  end
  ...
  def test_write_string_not_connected()
    ...
    conn = Scalaris::TransactionSingleOp.new()
    conn.close_connection()
    #assert_raises( Scalaris::ConnectionError ) { conn.write(@testTime.to_s + key, $_TEST_DATA[0]) }
  ...
  def test_write_list_not_connected()
    ...
    conn = Scalaris::TransactionSingleOp.new()
    conn.close_connection()
    #assert_raises( Scalaris::ConnectionError ) { conn.write(@testTime.to_s + key, [$_TEST_DATA[0], $_TEST_DATA[1]]) }
  ...
  def test_test_and_set_string_not_connected()
    ...
    conn = Scalaris::TransactionSingleOp.new()
    conn.close_connection()
    #assert_raises( Scalaris::ConnectionError ) { conn.test_and_set(@testTime.to_s + key, $_TEST_DATA[0], $_TEST_DATA[1]) }
    assert_raises( Scalaris::NotFoundError ) { conn.test_and_set(@testTime.to_s + key, $_TEST_DATA[0], $_TEST_DATA[1]) }
    conn.close_connection()
  end
  ...
  def test_test_and_set_list_not_connected()
    ...
    conn = Scalaris::TransactionSingleOp.new()
    conn.close_connection()
    #assert_raises( Scalaris::ConnectionError ) { conn.test_and_set(@testTime.to_s + key, "fail", [$_TEST_DATA[0], $_TEST_DATA[1]]) }
    assert_raises( Scalaris::NotFoundError ) { conn.test_and_set(@testTime.to_s + key, "fail", [$_TEST_DATA[0], $_TEST_DATA[1]]) }
    conn.close_connection()
  end
